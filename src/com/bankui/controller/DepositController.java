...
public class DepositController {
	...
	public String processTransfer(@ModelAttribute Transfer transfer, HttpSession session, Model model,@RequestParam("amount") double amount) {
		...
		String url="http://localhost:8585/deposit/"+amount ;
